...
type BConfig struct {
	...
	Port       struct { // 新配置方式
		Sip   string `default:"udp:15060"`
		Media string `default:"tcp:68200-69200"`
	}
	...
	MediaPort    uint16 `default:"68200"` //媒体服务器端口
	MediaNetwork string `default:"tcp"`   //媒体传输协议，默认UDP，可选TCP
	MediaPortMin uint16 `default:"68200"`
	MediaPortMax uint16 `default:"69200"`
